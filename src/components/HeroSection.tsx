    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center">
        <div className="container max-w-4xl mx-auto text-center p-4 text-white">
          <h1 className="text-7xl md:text-9xl font-bold mb-4 animate-fade-in drop-shadow-lg mt-[-100px]">
            <strong>우리가교회</strong>
          </h1>
          
          <LampContainer className="mt-[-50px]">
            <div className="mb-8 max-w-3xl mx-auto backdrop-blur-sm bg-black/30 rounded-lg p-6">
              <motion.p
                ...
                className="text-lg md:text-xl whitespace-pre-line leading-relaxed font-bold text-white"
              >
                {`하나님께서는 우리를 성전 삼아주시고,
성도라 부르셨습니다.
성도는 교회를 다니는 것이 아니라,
